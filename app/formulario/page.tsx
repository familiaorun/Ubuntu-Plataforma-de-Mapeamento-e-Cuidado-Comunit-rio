...
export default function FormularioPage() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const payload = { nome, telefone, bairro, mensagem, created_at: new Date().toISOString() }
      ...
      setStatus('err')
      setErrMsg(err?.message || 'Erro inesperado ao enviar.')
    }
  }
    ...
    <main style={{ padding: 24, fontFamily: 'system-ui', maxWidth: 720, margin: '0 auto' }}>
      ...
      <form onSubmit={onSubmit} style={{ display: 'grid', gap: 12, marginTop: 16 }}>
        ...
        <label>
          ...
          <textarea value={mensagem} onChange={(e) => setMensagem(e.target.value)} style={{ ...input, minHeight: 120 }} />
        </label>
